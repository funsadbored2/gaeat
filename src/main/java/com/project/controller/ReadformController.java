...
public class ReadformController {
	...
	public String getlist(@ModelAttribute ReadformVo readformVo, @ModelAttribute ReadformVo readformVo2,
			@ModelAttribute ReadformVo readformVo3, Model model, Model model2, HttpSession session) {
	...
	public String modify(@ModelAttribute ReadformVo readformVo, ModifyVo modifyVo, Model model) {
