...
public class SearchController {
	...
	public String list2(@RequestParam(value = "word") String word, Model wordData) {
		System.out.println("너가 넣은 검색어는 "+word);
		wordData.addAttribute("wordData", word);
		return "list/list";
	}

	@RequestMapping(value="list3", method = {RequestMethod.GET, RequestMethod.POST })
	public String list3(@RequestParam(value = "tag") String tag, Model tagData) {
		System.out.println("너가 넣은 태그는 "+tag);
		tagData.addAttribute("tagData", tag);
		return "list/list";
	}
