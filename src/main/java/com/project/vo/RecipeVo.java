...
public class RecipeVo {
    ...
    private String recipebook_title;
	...
	public RecipeVo(int rn, int recipe_no, String introduction, int chef_no, String recipe_title, String food_name,
			String reg_date, String cooking_level, String cooking_time, int recipebook_no, String recipebook_title,
			String cooking_method, String cooking_type, String food_img, int like_count, String nickname,
			String material, String tag, String amount) {
		super();
		this.rn = rn;
		this.recipe_no = recipe_no;
		this.introduction = introduction;
		...
		this.cooking_time = cooking_time;
		this.recipebook_no = recipebook_no;
		this.recipebook_title = recipebook_title;
		this.cooking_method = cooking_method;
		this.cooking_type = cooking_type;
		this.food_img = food_img;
		this.like_count = like_count;
	...
	public String toString() {
		return "RecipeVo [rn=" + rn + ", recipe_no=" + recipe_no + ", introduction=" + introduction + ", chef_no="
				...
				+ recipebook_no + ", recipebook_title=" + recipebook_title + ", cooking_method=" + cooking_method
				+ ", cooking_type=" + cooking_type + ", food_img=" + food_img + ", like_count=" + like_count
				+ ", nickname=" + nickname + ", material=" + material + ", tag=" + tag + ", amount=" + amount + "]";
	}
	...
	public String getRecipebook_title() {
		return recipebook_title;
	}

	public void setRecipebook_title(String recipebook_title) {
		this.recipebook_title = recipebook_title;
	}
