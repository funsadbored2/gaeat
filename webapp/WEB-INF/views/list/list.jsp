      ...
      <div class="radio">
         <div class="container" style="text-align:right;">
            <div class="btn-group" data-toggle="buttons" id="orderbtn">
               <label class="btn btn-success active" style="background-color:#b6c98f; color:white; border-style:none; margin-right:5px;"> 
                  <input type="radio" name="orderby" id="orderby1" value="요리명" checked>요리명
               </label> 
               <label class="btn btn-success" style="background-color:#b6c98f; color:white; border-style:none; margin-right:5px;"> 
                  <input type="radio" name="orderby" id="orderby2" value="제목순"> 제목순
               </label> 
               <label class="btn btn-success" style="background-color:#b6c98f; color:white; border-style:none; margin-right:5px;"> 
                  <input type="radio" name="orderby" id="orderby3" value="인기순"> 인기순
               </label> 
               <label class="btn btn-success" style="background-color:#b6c98f; color:white; border-style:none; margin-right:5px;"> 
                  <input type="radio" name="orderby" id="orderby4" value="작성자순"> 작성자순
               </label> 
               <label class="btn btn-success" style="background-color:#b6c98f; color:white; border-style:none; margin-right:5px;"> 
                  <input type="radio" name="orderby" id="orderby5" value="최신순"> 최신순
               </label>
            </div>
         </div>
      </div>
...
<script type="text/javascript">
   $(document).ready(function() {
      ...
      var tagNo = $("#hiddenTag").val();
      console.log($("#hiddenWord").val());
      if($("#hiddenWord").val() == 'hidden01'){
         inputkey = $("#search_word").val();
      } else {
         inputkey = $("#hiddenWord").val();
         $("#search_word").val($("#hiddenWord").val())
      }
      var kvo = new Object();
   ...
   function render(recipeVo) {
      ...
      if (recipeVo.food_img == "이미지 없음") {
         str += "<img src=\"${pageContext.request.contextPath}/assets/img/2.jpg\" alt=\"post img\" style=\"width: 348px; height: 220px;\"></a>";
      } else {
         str += "<img src=\""+recipeVo.food_img+"\" alt=\"post img\" style=\"width: 348px; height: 220px;\"></a>";
      }
      str += "</div>";
      str += "<div class=\"blog-content\">";
      str += "<h4>";
      str += "<a href=\"${pageContext.request.contextPath }/read/readform?recipe_no=" + recipeVo.recipe_no + "\" class = \"rltitle;\" style=\"font-size:13.5px;\">" + recipeVo.recipe_title + "</a>";
      ...
      str += "</div>";
      str += "<span class=\"blog-date\" style='font-size:15px;'>좋아요 " + recipeVo.like_count
            + "</span>";
      str += "</div>";
      str += "</div>";
   ...
   function drawPaging(page) {
      var str = "";
      str += "<div class=\"input-group   col-lg-6  col-md-6  col-sm-6 col-xs-12\"style=\"width:600px;\">";
      if (page.page == 1) { //련재페이지가 1이면 표시하지 않는다.
         str += "<input class=\"jumpBtn2\" style='background-color:#b6c98f; color:white; border-style:none;' type=\"button\" value=\"<<\" style=\"display: none;\">";
         str += "<input class=\"jumpBtn2\" style='background-color:#b6c98f; color:white; border-style:none;' type=\"button\" value=\"<\"  style=\"display: none;\">";
      } else {
         str += "<input class=\"jumpBtn2\" style='background-color:#b6c98f; color:white; border-style:none;' type=\"button\" value=\"<<\" onClick=\"gotoPage(1)\">";
         str += "<input class=\"jumpBtn2\" style='background-color:#b6c98f; color:white; border-style:none;' type=\"button\" value=\"<\" onClick=\"gotoPage("
               + page.prevPage + ")\">";
      }
      str += "<input type=\"text\" id=\"currNoBox\" value="+page.page+" class=\"pageNumT\" style=\"width:50px;\" >";
      str += "<label class=\"pageNumL\" > / " + page.totPage + "</label>";
      str += "<input  class=\"jumpBtn\" style='background-color:#b6c98f; color: white; border-style:none;' type=\"button\" value=\"이동\" onClick=\"gotoPage2()\">";
