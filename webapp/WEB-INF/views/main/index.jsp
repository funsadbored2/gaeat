		...
		<div id="carousel-generic" class="carousel slide">
		 ...
		 <div class="work" style = "margin-bottom: 150px">
		  <div class="category-buttons">
		    ...
		    <a href="#" data-group="nature">top20</a>
		    <a href="#" data-group="food">#비건</a>
		    <a href="#" data-group="sports">allergy.</a>
		    <a href="#" data-group="people">muslim.</a>
		  </div>
		  ...
		  <div id="grid" class="grid">
			...
			<c:forEach items = "${veganList}" var = "veganList">
		     ...
		     <%-- <a class="card" href="#" data-groups="food,">
		      ...
		      <div class="title">
      			<h style="font-size:14px;"><Strong>집에서 먹는 함박 샌드위치^^</Strong> </h>
				<h style="font-size:6px; color:green;">by </h>
				<h style="font-size:12px;">Kim Tae Hee </h>
				<p>집에서 이런 퀄리티를 자랑할 수 있어요@@@</p>	
			  </div>
		    </a>
...
<<<<<<< HEAD
                                                <h2 style="color: white; font-family:'squareRoundEB">제육볶음 하나만으로 좋아요 1위를 기록한 바로~~</h2>
=======
                                                <h2 style="color: white; font-family:'squareRoundEB'">제육볶음 하나만으로 좋아요 1위를 기록한 바로~~</h2>
>>>>>>> branch 'master' of https://github.com/funsadbored2/gaeat.git
                                                <br>
<<<<<<< HEAD
                                                <h5 style="color: #6F7C80; font-family:'squareRoundEB"><strong>-여윤철닉-</strong></h5>
=======
                                                <h5 style="color: #6F7C80; font-family:'squareRoundEB'"><strong>-여윤철닉-</strong></h5>
>>>>>>> branch 'master' of https://github.com/funsadbored2/gaeat.git
                                            </div>
                                ...
                                <div class="item">
                                        <div class="row">
                                            <div class="col-sm-8 col-sm-offset-2">
<<<<<<< HEAD
                                                <h2 style="color: white; font-family:'squareRoundEB">소고기 요리의 장인 그는!</h2>
=======
                                                <h2 style="color: white; font-family:'squareRoundEB'">소고기 요리의 장인 그는!</h2>
>>>>>>> branch 'master' of https://github.com/funsadbored2/gaeat.git
                                                <br>
<<<<<<< HEAD
                                                <h5 style="color: #6F7C80; font-family:'squareRoundEB"><strong>-은지닷-</strong></h5>
=======
                                                <h5 style="color: #6F7C80; font-family:'squareRoundEB'"><strong>-은지닷-</strong></h5>
>>>>>>> branch 'master' of https://github.com/funsadbored2/gaeat.git
                                            </div>
                                ...
                                <div class="item">
                                        <div class="row">
                                            <div class="col-sm-8 col-sm-offset-2">
<<<<<<< HEAD
                                                <h2 style="color: white; font-family:'squareRoundEB">채소만을 사용한 인기 채식 쉐프!</h2>
=======
                                                <h2 style="color: white; font-family:'squareRoundEB'">채소만을 사용한 인기 채식 쉐프!</h2>
>>>>>>> branch 'master' of https://github.com/funsadbored2/gaeat.git
                                                <br>
<<<<<<< HEAD
                                                <h5 style="color: #6F7C80; font-family:'squareRoundEB"><strong>-근섭만세-</strong></h5>
=======
                                                <h5 style="color: #6F7C80; font-family:'squareRoundEB'"><strong>-근섭만세-</strong></h5>
>>>>>>> branch 'master' of https://github.com/funsadbored2/gaeat.git
                                            </div>
			...
			<div class="container-fluid" style="margin-top: 20px;">
			    <div class="row">
			    	<div class = "trendText" align="center" >
						<h4 style = " font-family:'squareRoundEB'">채식주의자도, 알레르기가 있는 사람도, 특정 종교인 모두</h4>
		           		<h2 style = " font-family:'squareRoundEB'">가려 먹습니다.</h2>
					</div>
			    </div>
...
<<<<<<< HEAD
						<h5 style="line-height: 30px; padding-left: 30px; padding-top: 40px; font-family:'squareRoundEB';">
=======
						<h5 style="line-height: 30px; padding-left: 30px; padding-top: 40px; font-family:'squareRoundEB'">
>>>>>>> branch 'master' of https://github.com/funsadbored2/gaeat.git
				...
				<div class="row row-divided" style="margin-top: 40px;font-family:'squareRoundEB;">
					<div class="col-xs-6 column-one">
<<<<<<< HEAD
						<h5 style="line-height: 30px; padding-left: 10px; padding-top: 40px;font-family:'squareRoundEB';">
=======
						<h5 style="line-height: 30px; padding-left: 10px; padding-top: 40px; font-family:'squareRoundEB'">
>>>>>>> branch 'master' of https://github.com/funsadbored2/gaeat.git
