...
<body>
    ...
    <c:import url="/WEB-INF/views/includes/headNav.jsp"></c:import>
   	<div class="wrap-loading display-none">
    	<div>
    		<img src="${pageContext.request.contextPath}/assets/img/saving.gif" style = "height:50px; width:50px;"/>
    	</div>
	</div> 
	         ...
	         <div class="form-group">
	            ...
	            <div class="col-sm-10">
	               <textarea type="text" class="form-control" id="introduction" style = "resize: none; background-color: white;" 
						placeholder="요리를 간단하게 설명해주세요 EX) 가볍게 구운 검은깨 두부에 매운 파무침을 얹어 만든 고소하고 매콤한 두부 요리 "></textarea>
	            </div>
	         </div>
