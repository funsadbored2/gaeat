							...
							<div class="media-body">
								...
								<script>
									...
									$(document).on("click",".followed",function(){
										...
										str = "<a href='#' class='btn btn-xs btn-success following' name = '"+chef_no+"' style = 'background-color:#eef5ee; color:#689068;'><span class='glyphicon glyphicon-heart-empty'></span> 팔로우하기</a>";
					                	...
					                	<div class="artist-data pull-left">
					                        ...
					                        <div class="artst-prfle pull-right">
					                          ...
					                          <div class="counter-bottom">
					                           	<a href="${pageContext.request.contextPath}/userpage/followinglist?chef_no=${followedList.chef_no}">
						                            <span class=" badge badge-info">followers : ${followedList.followed_count }</span>
						                        </a>
						                        <c:choose>
						                        <c:when test="${authUser.chef_no==followedList.chef_no}">
